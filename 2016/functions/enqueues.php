...
function b4st_enqueues() {
  ...
  wp_register_style('b4st-css', get_template_directory_uri() . '/theme/css/b4st.css', false, null);
	...
	wp_register_style('narrow-css', get_template_directory_uri() . '/theme/css/narrow.css', false, null);
	wp_enqueue_style('narrow-css');

	wp_register_style('alumni-css', get_template_directory_uri() . '/theme/css/alumni.css', false, null);
	wp_enqueue_style('alumni-css');

	wp_register_style('font-awesome', get_template_directory_uri() . '/font-awesome/css/font-awesome.css', false, null);
